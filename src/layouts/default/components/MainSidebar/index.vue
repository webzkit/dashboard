...
const isShow = computed(() => {
    return (
        ...
        (unref(getDisplayMode) === DisplayModeEnum.MOBILE && unref(getMenuMode) !== MenuModeEnum.SINGLE)
    );
});
...
watch(
    ...
    (val) => {
        ...
        document.documentElement.style.setProperty("--g-sidebar-logo-height", height);
    },
    {
        immediate: true,
    }
